...
import { institutionalMemoryResponse } from "../data/mockData";
      ...
      setMessages((prev) => {
        ...
        return [
          ...prev,
          {
            id: "a-init",
            role: "assistant",
            text: institutionalMemoryResponse,
          },
        ];
      });
      setThinking(false);
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          id: `a-${Date.now()}`,
          role: "assistant",
          text: `Thank you for your question about "${text}". In the demo, this response would be generated by AI searching across all council meeting transcripts, agendas, and deliberation records. Louis will connect the real AI backend here.\n\nThe system would search across:\n- **Full meeting transcripts** from all committees\n- **Argument maps** and deliberation records\n- **Agendas and minutes** from council and committee meetings\n- **Historical records** tracking how issues have evolved over time`,
        },
      ]);
      setThinking(false);
    }, 1200);
